(function() {
  ...
  menu_template = "    <div class='J-M AW' role='menu' aria-haspopup='true' aria-activedescendant=''>        <div id='b4g_inner_menu' class='b4g_menu SK AX AW' style='margin-top:-1px;margin-left:5px;z-index:999;list-style:none;width:16em; font-size:100%;'>                <div>                    <a style='" + menu_link_style + "'>in 1 hour</a>                </div>                <div>                    <a style='" + menu_link_style + "; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(220, 220, 220); padding-bottom: 5px; margin-bottom: 5px; ' class='menu-anchor J-N'>in 1 day</a>                </div>                <div>                    <a style='" + menu_link_style + "' class='menu-anchor J-N'>in 2 days</a>                </div>                <div>                    <a style='" + menu_link_style + "' class='menu-anchor J-N'>in 4 days</a>                </div>                <div>                    <a style='" + menu_link_style + "' class='menu-anchor J-N'>in 1 week</a>                </div>                <div>                    <a style='" + menu_link_style + "' class='menu-anchor J-N'>in 2 weeks</a>                </div>                <div>                    <a style='" + menu_link_style + "' class='menu-anchor J-N'>in 1 month</a>                </div>                <div class='menu-caption' style='margin-left:3px'>By a specific time</div>                <div style='color: #333; font-style: italic; font-size: 0.8em; margin-top: 3px; margin-left: 3px;' class='b4g_menu'>Examples: <strong>\'Monday 9am\'</strong>, <strong>\'Dec 23\'</strong><br>                </div>                <form onsubmit='return false;'>                    <div style='padding-top:3px; vertical-align: middle;' class='b4g_menu'><input style='margin-left: 3px' class='b4g_menu hasDatepicker' type='text' name='time' id='datepicker'>                        <img class='ui-datepicker-trigger' src='https://b4g.baydin.com/site_media/bookmarklet/calendar.gif' alt='...' title='...' style='margin-left: 5px; vertical-align: middle; '>                    </div>                    <div style='color:#969696; margin-left: 3px;'>                        <span id='date-preview' class='b4g_menu' style='color:#327a01;'></span>                    </div>                    <div class='b4g_menu'>                        <input type='submit' value='Confirm' style='margin: 3px 0 5px 3px;' class='b4g_menu'>                    </div>                </form>            </div>        </div>    </div>";
  Reminder = (function() {
    function Reminder() {
    ...
    Reminder.prototype.addUI = function() {
      ...
      container.find('#emailReminder-send').bind('click', __bind(function(evt) {
        if (!$(evt.currentTarget).find('.J_M').length) {
          $(menu_template).appendTo($(evt.currentTarget)).bind('click', __bind(function() {
      ...
      return $(this.doc).bind('click', __bind(function(evt) {
        if (!$(evt.currentTarget, this.doc).closest('.J-M').length) {
